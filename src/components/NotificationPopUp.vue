...
export default {
    ...
    methods: {
        ...
        markAsRead: async function (id) {
            this.axios.post(`https://zapsterfinance.onrender.com/notifications/mark/${id}`).then(() => {
        ...
        markAllAsRead: async function () {
            this.axios.post(`https://zapsterfinance.onrender.com/notifications/markall?to=${this.userAddress.toLowerCase()}`).then(() => {
                this.getNotifications()
            }).catch(error => {
                console.error(error);
            })
        ...
        getNotifications: function () {
            ...
            this.fetching = true
            this.axios.get(`https://zapster.onrender.com/notifications?to=${this.userAddress.toLowerCase()}`).then(response => {
