...
import ZapScore from '../../../../scripts/ZapScore'
...
export default {
    ...
    methods: {
        ...
        fetchLendingOffer: async function (fetching = true) {
            ...
            try {
                let response = await this.axios.get(`https://zapsterfinance.onrender.com/offers/${id}`);
        ...
        getLenderScore: async function (address) {
            this.lenderScore = await ZapScore.getZapScore(address);
        },
