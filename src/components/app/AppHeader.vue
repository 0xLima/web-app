    ...
    <main>
        ...
        <div class="header">
            <div class="pages">
                ...
                <a href="https://zapsterfinance.gitbook.io/product-docs" target="_blank">Docs</a>
                <a href="#">Governance</a>
...
export default {
    ...
    methods: {
        ...
        checkNotification: function (userAddress) {
            if (!userAddress)
                return;
            this.axios.get(`https://zapsterfinance.onrender.com/notifications?to=${userAddress.toLowerCase()}&readAt=0`).then(response => {
