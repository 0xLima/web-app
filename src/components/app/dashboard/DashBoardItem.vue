...
export default {
    ...
    methods: {
        renderChart: function () {
            var options = {
                ...
                fill: {
                    ...
                    gradient: {
                        type: "vertical",
                        gradientToColors: ["#FF0044", "#FF0044"],
                        inverseColors: true,
                        opacityFrom: 0.5,
                        opacityTo: 0.05
                    }
        ...
        getLoans: function () {
            ...
            this.axios.get(`https://zapsterfinance.onrender.com/loans/vault?address=${this.userAddress.toLowerCase()}`).then(response => {
        ...
        getProfile: async function () {
            if (!this.userAddress) return
            this.axios.get(`https://zapsterfinance.onrender.com/users/${this.userAddress.toLowerCase()}`).then(response => {
        ...
        getTransfers: function() {
            if (!this.userAddress) return
            this.axios.get(`https://zapsterfinance.onrender.com/transfers?from=${this.userAddress.toLowerCase()}`).then(response => {
